...
export default function ChatPreview({ name, message, time, unread, typing, image, pinned, oneTickBlue, doubleTickblue, active }) {
    return (
        <div className={`p-3 rounded-md cursor-pointer flex items-start transition-all hover:bg-gray-100`}>
